...
export function findYouTubeRightControls(silent: boolean = false): Element | null {
...
export function getVideoContainer(): Element | null {
  return (
    document.querySelector(YOUTUBE_SELECTORS.MOVIE_PLAYER) || document.querySelector(YOUTUBE_SELECTORS.VIDEO_PLAYER)
  );
}
